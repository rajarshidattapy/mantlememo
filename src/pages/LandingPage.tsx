        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              <img src={mantleLogo} alt="Mantlememo" className="h-8 w-8" />
            ...
            <div className="code-block-floating overflow-hidden">
              <div className="status-hud px-6 py-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-mantle-400">Mantlememo-agent.py</span>
                </div>
              ...
              <div className="status-hud px-6 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6 text-sm text-mantle-400">
                  ...
                  <div>
                    <span className="font-semibold text-white">24.1 MNT</span> Total Revenue
                  </div>
          ...
          <div className="glass-strong p-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                { label: "Revenue Generated", val: "2.4M", sub: "MNT to creators" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-mantle-300 max-w-3xl mx-auto">
              Mantlememo turns ephemeral chats into persistent, composable, and revenue-generating
              primitives.
            </p>
            <a
              href="#"
          ...
          <div className="space-y-24">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-mantle-300 text-lg">
                  Stake MNT behind your capsule to signal reputation and boost visibility in the
                  marketplace.
                </p>
              </div>
              <div className="card-mantle p-8">
                <div className="text-center">
                  <div className="text-5xl font-bold text-mantle-400 mb-2">450 MNT</div>
                  ...
                  <div className="space-y-3">
                    <div className="glass p-3">
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <span className="text-mantle-300 font-semibold">0.005 MNT</span>
                      </div>
                    </div>
                    <div className="glass p-3">
                      <div className="flex justify-between items-center text-sm">
                        <span className="text-mantle-400">Creator Revenue</span>
                        <span className="text-mantle-300 font-semibold">0.0045 MNT</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div className="glass p-4 flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-lg font-bold text-mantle-400">{capsule.price} MNT</div>
                  </div>
          ...
          <div className="glass-strong p-12">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-4xl font-bold mb-4">Build on Mantlememo</h2>
              ...
              <div className="card-mantle p-6 font-mono text-sm">
                <div className="text-mantle-400 mb-4">
                  ...
                  <br />
                  <span className="text-mantle-400">npm install</span> @Mantlememo/sdk
                </div>
          ...
          <div className="glass p-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-mantle-400">Mantlememo</span>
              </div>
              ...
              <div className="text-mantle-500 text-sm">
                © 2026 Mantlememo Protocol. All rights reserved.
              </div>
            </div>
          </div>
        </div>
