...
const Staking = () => {
  ...
  const handleCreateCapsule = async (agentId: string, agentName: string) => {
    ...
    try {
      ...
      alert(`Successfully created and staked ${amount} MNT on capsule for ${agentName}!`);
  ...
  const handleStakeMore = async (capsuleId: string, capsuleName: string) => {
    ...
    try {
      ...
      alert(`Successfully added ${amount} MNT stake to ${capsuleName}!`);
  ...
  const handleUnstake = async (capsuleId: string, capsuleName: string) => {
    ...
    try {
      ...
      alert(`Successfully unstaked ${amount} MNT from ${capsuleName}!`);
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Stake MNT on your agents to list them in the marketplace</p>
        </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-2 text-sm">
                        <span className="text-green-400">
                          ...
                          {capsule.stake_amount} MNT staked
                        </span>
                        <span className="text-blue-400">
                          {capsule.price_per_query} MNT per query
                        </span>
                        <span className="text-purple-400">
                          {capsule.earnings} MNT earned
                        </span>
                      </div>
                    </div>
              ...
              return (
                <div key={agent.id} className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
                  ...
                  <div className="mt-3 text-xs text-gray-400">
                    Min: 0.0001 MNT • Max: 100 MNT • Lock period: 7 days
                  </div>
                </div>
              );
            })}
